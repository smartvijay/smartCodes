...
if (isset($_POST['name']) && isset($_POST['mobile']) && isset($_POST['email']) && isset($_POST['role'])
             && isset($_POST['gender']) && isset($_POST['course']) && isset($_POST['date'])
    ...
    $query = "INSERT INTO course(name,mobile,email,role,gender,course,date,country,state,city,pin,address) VALUES('$name','$mobile','$email','$role','$gender','$course','$date','$country','$state','$city','$pin','$address')";
