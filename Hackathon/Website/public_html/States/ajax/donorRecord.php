...
if (isset($_POST['name']) && isset($_POST['mobile']) && isset($_POST['email']) && isset($_POST['role'])
             && isset($_POST['gender']) && isset($_POST['amount']) && isset($_POST['date'])
    ...
    $query = "INSERT INTO donors(name,mobile,email,role,gender,amount,date,country,state,city,pin,address) VALUES('$name','$mobile','$email','$role','$gender','$amount','$date','$country','$state','$city','$pin','$address')";
