...
public class ModuleSupport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.module_support);
        ...
        String url = "https://advisory.bdo.be/covid-19/";
        simpleWebView.getSettings().setJavaScriptEnabled(true);
        simpleWebView.loadUrl(url); // load a web page in a web view

        //web page load

        pd = new ProgressDialog(ModuleSupport.this);
...
//                        simpleWebView.stopLoading();
        ...
        simpleWebView.setWebViewClient(new WebViewClient() {
            ProgressDialog progressDialog = new ProgressDialog(ModuleSupport.this);
