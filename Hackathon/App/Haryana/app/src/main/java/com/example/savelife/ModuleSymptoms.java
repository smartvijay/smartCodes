...
public class ModuleSymptoms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.module_symptoms);
        ...
        String url = "https://www.mayoclinic.org/diseases-conditions/coronavirus/symptoms-causes/syc-20479963";
        simpleWebView.getSettings().setJavaScriptEnabled(true);
        simpleWebView.loadUrl(url); // load a web page in a web view

        //web page load

        pd = new ProgressDialog(ModuleSymptoms.this);
...
//                        simpleWebView.stopLoading();
        ...
        simpleWebView.setWebViewClient(new WebViewClient() {
            ProgressDialog progressDialog = new ProgressDialog(ModuleSymptoms.this);
