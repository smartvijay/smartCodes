...
public class ModuleWorkers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.module_workers);
        ...
        String url = "https://www.ttl.fi/en/guidelines-for-workers-to-prevent-novel-coronavirus-infection/";
        simpleWebView.getSettings().setJavaScriptEnabled(true);
        simpleWebView.loadUrl(url); // load a web page in a web view

        //web page load

        pd = new ProgressDialog(ModuleWorkers.this);
...
//                        simpleWebView.stopLoading();
        ...
        simpleWebView.setWebViewClient(new WebViewClient() {
            ProgressDialog progressDialog = new ProgressDialog(ModuleWorkers.this);
