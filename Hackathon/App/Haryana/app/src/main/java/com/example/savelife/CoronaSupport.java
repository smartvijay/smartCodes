...
public class CoronaSupport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.corona_support);
        ...
        String url = "https://www.healthleadersmedia.com/clinical-care/how-establish-coronavirus-employee-wellness-support-teams-hospitals";
        simpleWebView.getSettings().setJavaScriptEnabled(true);
        simpleWebView.loadUrl(url); // load a web page in a web view

        //web page load

        pd = new ProgressDialog(CoronaSupport.this);
...
//                        simpleWebView.stopLoading();
        ...
        simpleWebView.setWebViewClient(new WebViewClient() {
            ProgressDialog progressDialog = new ProgressDialog(CoronaSupport.this);
