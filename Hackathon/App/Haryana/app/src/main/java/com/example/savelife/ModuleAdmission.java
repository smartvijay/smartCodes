...
public class ModuleAdmission extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "https://savemylifefromcovid.000webhostapp.com/States/Tamil_Nadu.html";
        simpleWebView.getSettings().setJavaScriptEnabled(true);
        simpleWebView.loadUrl(url); // load a web page in a web view

        //web page load

        pd = new ProgressDialog(ModuleAdmission.this);
...
//                        simpleWebView.stopLoading();
        ...
        simpleWebView.setWebViewClient(new WebViewClient() {
            ProgressDialog progressDialog = new ProgressDialog(ModuleAdmission.this);
