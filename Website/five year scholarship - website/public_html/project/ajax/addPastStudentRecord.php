...
if (isset($_POST['name']) && isset($_POST['mobile']) && isset($_POST['email']) && isset($_POST['role'])
    ...
    $query = "INSERT INTO past_student_details(name,mobile,email,role,gender,problem,date,country,state,city,pin,address) VALUES('$name','$mobile','$email','$role','$gender','$problem','$date','$country','$state','$city','$pin','$address')";
