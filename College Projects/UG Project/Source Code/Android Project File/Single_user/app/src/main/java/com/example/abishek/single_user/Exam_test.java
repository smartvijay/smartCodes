...
public class Exam_test extends AppCompatActivity {

    RequestQueue requestQueue;

    final String url = "http://192.168.225.45/project/single_user_mysql/test.php";


    TextView Ttest_title, Tsub_code_1, Tsub_dis_1, Tsub_mark_1, Tsub_result_1, Tsub_code_2, Tsub_dis_2, Tsub_mark_2, Tsub_result_2,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ttest_title = findViewById(R.id.header);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        String abs_title = test.getString("test_title");

                        String subCode_1 = test.getString("sub_code_1");
                        String subDes_1 = test.getString("sub_dis_1");
                        int subMark_1 = test.getInt("sub_mark_1");
                        String subResult_1 = test.getString("sub_result_1");

                        String subCode_2 = test.getString("sub_code_2");
                        String subDes_2 = test.getString("sub_dis_2");
                        int subMark_2 = test.getInt("sub_mark_2");
                        String subResult_2 = test.getString("sub_result_2");

                        String subCode_3 = test.getString("sub_code_3");
                        String subDes_3 = test.getString("sub_dis_3");
                        int subMark_3 = test.getInt("sub_mark_3");
                        String subResult_3 = test.getString("sub_result_3");

                        String subCode_4 = test.getString("sub_code_4");
                        String subDes_4 = test.getString("sub_dis_4");
                        int subMark_4 = test.getInt("sub_mark_4");
                        String subResult_4 = test.getString("sub_result_4");

                        String subCode_5 = test.getString("sub_code_5");
                        String subDes_5 = test.getString("sub_dis_5");
                        int subMark_5 = test.getInt("sub_mark_5");
                        String subResult_5 = test.getString("sub_result_5");

                        String subCode_6 = test.getString("sub_code_6");
                        String subDes_6 = test.getString("sub_dis_6");
                        int subMark_6 = test.getInt("sub_mark_6");
                        String subResult_6 = test.getString("sub_result_6");


                        Ttest_title.setText(abs_title);
